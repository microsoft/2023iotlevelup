...
conn_str = os.getenv("conn_str").replace("\"","")
osname = ""
...
if conn_str == None:
    ...
    print(" example:   conn_str=\"HostName=ksaye.azure-devices.net;DeviceId=python;SharedAccessKey=4sDfmCBS1MnfVsQxUv/rEksRlzOctcOU=\"")
    print("exiting now")
    quit()
...
reported_properties = {"OS": osname, "CurrentUser": str(os.getlogin()), "IP": str(socket.gethostbyname(socket.gethostname()))}
